---
id: CPE-203
title: Preview/edit support for PlantUML diagrams files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for PlantUML diagrams (.puml/.plantuml) in the right-side preview pane. Highlighted PlantUML. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [x] .puml/.plantuml is matched by a dedicated preview provider in the bundled registry
