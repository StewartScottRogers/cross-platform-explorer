...
Add a preview provider for Makefile (Makefile/.mk) in the right-side preview pane. Highlighted Makefile. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] Makefile/.mk is matched by a dedicated preview provider in the bundled registry
