---
id: CPE-174
title: Preview/edit support for Haxe files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Haxe (.hx) in the right-side preview pane. Highlighted Haxe source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .hx is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Haxe source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: haxe. Editing model: source.
