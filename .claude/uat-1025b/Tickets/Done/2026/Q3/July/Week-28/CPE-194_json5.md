---
id: CPE-194
title: Preview/edit support for JSON5 files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for JSON5 (.json5) in the right-side preview pane. Highlighted JSON5. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .json5 is matched by a dedicated preview provider in the bundled registry
