...
Add a preview provider for C++ (.cpp/.cc/.cxx) in the right-side preview pane. Color-coded C++ source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .cpp/.cc/.cxx is matched by a dedicated preview provider in the bundled registry
