---
id: CPE-148
title: Preview/edit support for Ada files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Ada (.adb/.ads) in the right-side preview pane. Highlighted Ada source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .adb/.ads is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: ada. Editing model: source.
