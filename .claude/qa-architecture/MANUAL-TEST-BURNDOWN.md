...
`timeout-minutes` cut 45→15. Rows #1/#2/#4 flipped ✅ above (macOS + the Windows canary noted as residuals);
row #3 stays 🔧 (screenshots now reach CI, real baselines still owed). Follow-up filed: **CPE-1595**
(triage the 7 known-failing specs, `network.smoke.ts` first).
