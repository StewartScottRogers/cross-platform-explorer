...
| CPE-1093 | Batch-media dialog: pill reflow / progress-bar / theme colours / real image transforms | headless UAT+review only — narrow-dialog reflow, bar animation, light/dark, actual resize/convert/rotate output need human eyes | open | 2026-07-26 |
