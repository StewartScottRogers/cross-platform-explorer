---
id: CPE-167
title: Preview/edit support for GraphQL files
type: Feature
status: Done
priority: Medium
component: Frontend
...
Add a preview provider for GraphQL (.graphql/.gql) in the right-side preview pane. Highlighted GraphQL. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .graphql/.gql is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: graphql. Editing model: source.
