---
id: CPE-149
title: Preview/edit support for x86 Assembly files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for x86 Assembly (.asm/.s) in the right-side preview pane. Highlighted assembly source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .asm/.s is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted assembly source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: x86asm. Editing model: source.
