---
id: CPE-155
title: Preview/edit support for Scheme files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Scheme (.scm/.ss) in the right-side preview pane. Highlighted Scheme source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .scm/.ss is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Scheme source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: scheme. Editing model: source.
