---
id: CPE-141
title: Preview/edit support for F# files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for F# (.fs/.fsx) in the right-side preview pane. Highlighted F# source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .fs/.fsx is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: fsharp. Editing model: source.
