---
id: CPE-135
title: Preview/edit support for Julia files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Julia (.jl) in the right-side preview pane. Highlighted Julia source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .jl is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Julia source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: julia. Editing model: source.
