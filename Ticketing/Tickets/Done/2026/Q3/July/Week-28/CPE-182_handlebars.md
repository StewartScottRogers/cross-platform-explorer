---
id: CPE-182
title: Preview/edit support for Handlebars templates files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Handlebars templates (.hbs) in the right-side preview pane. Highlighted Handlebars. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .hbs is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: handlebars. Editing model: source.
