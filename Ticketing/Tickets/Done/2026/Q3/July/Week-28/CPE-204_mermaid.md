---
id: CPE-204
title: Preview/edit support for Mermaid diagrams files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Mermaid diagrams (.mmd) in the right-side preview pane. Highlighted source; optional diagram render. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [x] .mmd is matched by a dedicated preview provider in the bundled registry
...
- [x] Viewer: Highlighted source; optional diagram render.
