---
id: CPE-145
title: Preview/edit support for Fortran files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Fortran (.f90/.f95) in the right-side preview pane. Highlighted Fortran source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .f90/.f95 is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Fortran source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: fortran. Editing model: source.
