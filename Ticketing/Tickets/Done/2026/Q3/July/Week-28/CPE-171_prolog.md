---
id: CPE-171
title: Preview/edit support for Prolog files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Prolog (.prolog/.pro) in the right-side preview pane. Highlighted Prolog source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .prolog/.pro is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Prolog source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: prolog. Editing model: source.
