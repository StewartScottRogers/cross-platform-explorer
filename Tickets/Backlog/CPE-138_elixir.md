---
id: CPE-138
title: Preview/edit support for Elixir files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for Elixir (.ex/.exs) in the right-side preview pane. Highlighted Elixir source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .ex/.exs is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Elixir source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: elixir. Editing model: source.
