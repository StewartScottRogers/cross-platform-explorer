---
id: CPE-173
title: Preview/edit support for ReasonML files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for ReasonML (.re/.rei) in the right-side preview pane. Highlighted Reason source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .re/.rei is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Reason source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: reasonml. Editing model: source.
