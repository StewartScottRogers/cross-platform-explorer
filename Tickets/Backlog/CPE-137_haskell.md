---
id: CPE-137
title: Preview/edit support for Haskell files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for Haskell (.hs) in the right-side preview pane. Highlighted Haskell source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .hs is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Haskell source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: haskell. Editing model: source.
