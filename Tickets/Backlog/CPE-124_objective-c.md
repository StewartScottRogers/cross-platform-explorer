---
id: CPE-124
title: Preview/edit support for Objective-C files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for Objective-C (.m/.mm) in the right-side preview pane. Highlighted Objective-C. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .m/.mm is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Objective-C.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: objectivec. Editing model: source.
