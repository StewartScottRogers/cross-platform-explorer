---
id: CPE-136
title: Preview/edit support for Dart files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for Dart (.dart) in the right-side preview pane. Highlighted Dart source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .dart is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Dart source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: dart. Editing model: source.
