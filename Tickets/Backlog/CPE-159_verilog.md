---
id: CPE-159
title: Preview/edit support for Verilog files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for Verilog (.v) in the right-side preview pane. Highlighted Verilog source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .v is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Verilog source.
