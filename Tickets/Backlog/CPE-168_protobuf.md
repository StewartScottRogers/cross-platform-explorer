---
id: CPE-168
title: Preview/edit support for Protocol Buffers files
type: Feature
status: Open
priority: Medium
component: Frontend
...
Add a preview provider for Protocol Buffers (.proto) in the right-side preview pane. Highlighted protobuf. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .proto is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: protobuf. Editing model: source.
