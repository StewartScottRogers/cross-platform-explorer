---
id: CPE-172
title: Preview/edit support for Elm files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for Elm (.elm) in the right-side preview pane. Highlighted Elm source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .elm is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: elm. Editing model: source.
