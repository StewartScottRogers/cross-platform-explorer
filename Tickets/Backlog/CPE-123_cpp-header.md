---
id: CPE-123
title: Preview/edit support for C++ header files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for C++ header (.hpp/.hh) in the right-side preview pane. Highlighted C++ header. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .hpp/.hh is matched by a dedicated preview provider in the bundled registry
