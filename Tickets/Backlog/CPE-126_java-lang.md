---
id: CPE-126
title: Preview/edit support for Java files
type: Feature
status: Open
priority: Medium
component: Frontend
...
Add a preview provider for Java (.java) in the right-side preview pane. Highlighted Java source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .java is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Java source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: java. Editing model: source.
