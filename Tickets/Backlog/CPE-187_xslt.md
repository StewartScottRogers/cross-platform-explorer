---
id: CPE-187
title: Preview/edit support for XSLT stylesheets files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for XSLT stylesheets (.xsl/.xslt) in the right-side preview pane. Highlighted XSLT. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .xsl/.xslt is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: xml. Editing model: source.
