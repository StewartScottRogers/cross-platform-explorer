---
id: CPE-157
title: Preview/edit support for Tcl files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for Tcl (.tcl) in the right-side preview pane. Highlighted Tcl source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .tcl is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: tcl. Editing model: source.
