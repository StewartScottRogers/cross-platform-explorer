...
## Acceptance Criteria
- [ ] Default view = Agent, Provider, Account(when ≥2 keys), Model, Project folder + Keys…/Recent…/
      Manage agents ▾/? /Launch. No Fast model / API key / Setup visible.
- [ ] An "Advanced ▾" toggle reveals Fast model + per-launch API key + Setup controls.
- [ ] Wiring/ids unchanged; harness tests: fields hidden by default, toggle shows them.
