---
id: CPE-166
title: Preview/edit support for Dockerfile files
type: Feature
status: Open
priority: Medium
component: Frontend
...
Add a preview provider for Dockerfile (Dockerfile) in the right-side preview pane. Highlighted Dockerfile. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] Dockerfile is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: dockerfile. Editing model: source.
