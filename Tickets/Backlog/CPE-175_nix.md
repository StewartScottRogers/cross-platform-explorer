---
id: CPE-175
title: Preview/edit support for Nix files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for Nix (.nix) in the right-side preview pane. Highlighted Nix source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .nix is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: nix. Editing model: source.
