---
id: CPE-143
title: Preview/edit support for Groovy files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for Groovy (.groovy) in the right-side preview pane. Highlighted Groovy source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .groovy is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Groovy source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: groovy. Editing model: source.
