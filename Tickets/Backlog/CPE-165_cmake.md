---
id: CPE-165
title: Preview/edit support for CMake files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for CMake (.cmake/CMakeLists.txt) in the right-side preview pane. Highlighted CMake. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .cmake/CMakeLists.txt is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: cmake. Editing model: source.
