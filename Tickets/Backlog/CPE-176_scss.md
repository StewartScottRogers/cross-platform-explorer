---
id: CPE-176
title: Preview/edit support for SCSS files
type: Feature
status: Open
priority: Medium
component: Frontend
...
Add a preview provider for SCSS (.scss) in the right-side preview pane. Highlighted SCSS. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .scss is matched by a dedicated preview provider in the bundled registry
