---
id: CPE-179
title: Preview/edit support for Stylus files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for Stylus (.styl) in the right-side preview pane. Highlighted Stylus. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .styl is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: stylus. Editing model: source.
