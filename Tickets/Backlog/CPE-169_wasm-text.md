---
id: CPE-169
title: Preview/edit support for WebAssembly text files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for WebAssembly text (.wat) in the right-side preview pane. Highlighted WAT source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .wat is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: wasm. Editing model: source.
