---
id: CPE-163
title: Preview/edit support for AWK files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for AWK (.awk) in the right-side preview pane. Highlighted AWK source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .awk is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: awk. Editing model: source.
