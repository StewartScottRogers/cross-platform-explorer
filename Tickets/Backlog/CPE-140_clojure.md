---
id: CPE-140
title: Preview/edit support for Clojure files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for Clojure (.clj/.cljs) in the right-side preview pane. Highlighted Clojure source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .clj/.cljs is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Clojure source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: clojure. Editing model: source.
