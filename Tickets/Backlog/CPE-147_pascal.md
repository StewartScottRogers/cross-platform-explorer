---
id: CPE-147
title: Preview/edit support for Pascal/Delphi files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for Pascal/Delphi (.pas) in the right-side preview pane. Highlighted Pascal source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .pas is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Pascal source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: delphi. Editing model: source.
