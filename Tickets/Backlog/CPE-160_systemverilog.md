---
id: CPE-160
title: Preview/edit support for SystemVerilog files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for SystemVerilog (.sv) in the right-side preview pane. Highlighted SystemVerilog source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .sv is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted SystemVerilog source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: verilog. Editing model: source.
