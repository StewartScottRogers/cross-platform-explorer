---
id: CPE-162
title: Preview/edit support for PowerShell module/manifest files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for PowerShell module/manifest (.psm1/.psd1) in the right-side preview pane. Highlighted PowerShell. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .psm1/.psd1 is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: powershell. Editing model: source.
