...
- [ ] .svg is matched by a dedicated preview provider, registered in the bundled provider registry
- [ ] Viewer: Sandboxed render plus source edit and dimensions readout.
