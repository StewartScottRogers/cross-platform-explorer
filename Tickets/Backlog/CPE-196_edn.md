---
id: CPE-196
title: Preview/edit support for EDN (Clojure data) files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for EDN (Clojure data) (.edn) in the right-side preview pane. Highlighted EDN. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .edn is matched by a dedicated preview provider in the bundled registry
