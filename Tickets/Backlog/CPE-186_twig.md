---
id: CPE-186
title: Preview/edit support for Twig templates files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for Twig templates (.twig) in the right-side preview pane. Highlighted Twig. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .twig is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: twig. Editing model: source.
