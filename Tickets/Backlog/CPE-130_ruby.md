---
id: CPE-130
title: Preview/edit support for Ruby files
type: Feature
status: Open
priority: Medium
component: Frontend
...
Add a preview provider for Ruby (.rb) in the right-side preview pane. Highlighted Ruby source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .rb is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Ruby source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: ruby. Editing model: source.
