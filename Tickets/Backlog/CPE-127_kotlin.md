---
id: CPE-127
title: Preview/edit support for Kotlin files
type: Feature
status: Open
priority: Medium
component: Frontend
...
Add a preview provider for Kotlin (.kt/.kts) in the right-side preview pane. Highlighted Kotlin source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .kt/.kts is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Kotlin source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: kotlin. Editing model: source.
