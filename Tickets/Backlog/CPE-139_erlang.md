---
id: CPE-139
title: Preview/edit support for Erlang files
type: Feature
status: Open
priority: Low
component: Frontend
...
Add a preview provider for Erlang (.erl) in the right-side preview pane. Highlighted Erlang source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .erl is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Erlang source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: erlang. Editing model: source.
