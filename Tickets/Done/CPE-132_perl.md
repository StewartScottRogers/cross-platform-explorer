---
id: CPE-132
title: Preview/edit support for Perl files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Perl (.pl/.pm) in the right-side preview pane. Highlighted Perl source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .pl/.pm is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Perl source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: perl. Editing model: source.
