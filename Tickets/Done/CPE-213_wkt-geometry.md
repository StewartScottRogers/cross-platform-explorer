---
id: CPE-213
title: Preview/edit support for Well-Known Text geometry files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Well-Known Text geometry (.wkt) in the right-side preview pane. Highlighted geometry. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [x] .wkt is matched by a dedicated preview provider in the bundled registry
