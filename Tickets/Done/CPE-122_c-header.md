---
id: CPE-122
title: Preview/edit support for C/C++ header files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for C/C++ header (.h) in the right-side preview pane. Highlighted header source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .h is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted header source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: c/cpp. Editing model: source.
