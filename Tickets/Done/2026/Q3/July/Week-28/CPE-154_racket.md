---
id: CPE-154
title: Preview/edit support for Racket files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Racket (.rkt) in the right-side preview pane. Highlighted Racket source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .rkt is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Racket source.
