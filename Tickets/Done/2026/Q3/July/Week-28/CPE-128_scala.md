---
id: CPE-128
title: Preview/edit support for Scala files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Scala (.scala) in the right-side preview pane. Highlighted Scala source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .scala is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Scala source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: scala. Editing model: source.
