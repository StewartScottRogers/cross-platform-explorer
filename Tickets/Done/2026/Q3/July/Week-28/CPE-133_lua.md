---
id: CPE-133
title: Preview/edit support for Lua files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Lua (.lua) in the right-side preview pane. Highlighted Lua source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .lua is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: lua. Editing model: source.
