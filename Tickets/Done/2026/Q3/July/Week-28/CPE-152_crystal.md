---
id: CPE-152
title: Preview/edit support for Crystal files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Crystal (.cr) in the right-side preview pane. Highlighted Crystal source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .cr is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Crystal source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: crystal. Editing model: source.
