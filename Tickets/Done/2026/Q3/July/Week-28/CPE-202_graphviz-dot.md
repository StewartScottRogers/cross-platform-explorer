---
id: CPE-202
title: Preview/edit support for Graphviz DOT files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Graphviz DOT (.dot/.gv) in the right-side preview pane. Highlighted DOT; optional graph render. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [x] .dot/.gv is matched by a dedicated preview provider in the bundled registry
...
- [x] Viewer: Highlighted DOT; optional graph render.
