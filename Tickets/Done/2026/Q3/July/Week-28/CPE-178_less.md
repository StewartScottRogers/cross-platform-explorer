---
id: CPE-178
title: Preview/edit support for Less files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Less (.less) in the right-side preview pane. Highlighted Less. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .less is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: less. Editing model: source.
