---
id: CPE-131
title: Preview/edit support for PHP files
type: Feature
status: Done
priority: Medium
component: Frontend
...
Add a preview provider for PHP (.php) in the right-side preview pane. Highlighted PHP source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .php is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: php. Editing model: source.
