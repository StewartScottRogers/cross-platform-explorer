---
id: CPE-125
title: Preview/edit support for Go files
type: Feature
status: Done
priority: Medium
component: Frontend
...
Add a preview provider for Go (.go) in the right-side preview pane. Highlighted Go source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .go is matched by a dedicated preview provider in the bundled registry
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: go. Editing model: source.
