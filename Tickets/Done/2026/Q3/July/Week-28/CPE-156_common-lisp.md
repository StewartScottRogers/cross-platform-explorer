---
id: CPE-156
title: Preview/edit support for Common Lisp files
type: Feature
status: Done
priority: Low
component: Frontend
...
Add a preview provider for Common Lisp (.lisp/.lsp) in the right-side preview pane. Highlighted Lisp source. Editable as source text, saved via the write_file_text command (CPE-066).

## Acceptance Criteria

- [ ] .lisp/.lsp is matched by a dedicated preview provider in the bundled registry
...
- [ ] Viewer: Highlighted Lisp source.
...
Part of the [[CPE-059]] preview architecture. Approach: highlight.js grammar: lisp. Editing model: source.
