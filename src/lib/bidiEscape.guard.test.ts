...
const REGISTRY: Record<string, string[]> = {
  ...
  // sentence (already stripped of its embedded path by genericizeReason — see this file's own comment), and
