...
const REGISTRY: Record<string, string[]> = {
  ...
  "ExplorerPane.svelte": ["578:$t(\"menu.view\")","580:$t(\"view.details\")","581:$t(\"view.list\")","582:$t(\"tb.icons\")","583:$t(\"view.gallery\")","587:$t(\"tb.sortBy\")","589:$t(\"sort.name\")","590:$t(\"tb.modified\")","591:$t(\"sort.type\")","592:$t(\"sort.size\")","596:$t(\"tb.direction\")","598:$t(\"cmd.ascending\")","599:$t(\"cmd.descending\")","603:$t(\"cmd.showHidden\")","610:$t(\"tb.fileList\")","646:$t(\"agent.watch\", { name: watchedAgentName })","648:baseName(c.path)","648:c.kind === \"removed\" ? \"−\" : c.kind === \"created\" ? \"+\" : \"~\"","648:c.path","651:$t(\"agent.watching\")","653:$t(\"agent.showLog\")","654:$agentTimeline.length ? `(${$agentTimeline.length})` : \"\"","654:$t(\"agent.log\")","661:selectedTag","662:visible.length"],
