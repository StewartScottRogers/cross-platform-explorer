...
const REGISTRY: Record<string, string[]> = {
  ...
  "ExplorerPane.svelte": ["532:$t(\"menu.view\")","534:$t(\"view.details\")","535:$t(\"view.list\")","536:$t(\"tb.icons\")","537:$t(\"view.gallery\")","541:$t(\"tb.sortBy\")","543:$t(\"sort.name\")","544:$t(\"tb.modified\")","545:$t(\"sort.type\")","546:$t(\"sort.size\")","550:$t(\"tb.direction\")","552:$t(\"cmd.ascending\")","553:$t(\"cmd.descending\")","557:$t(\"cmd.showHidden\")","564:$t(\"tb.fileList\")","600:$t(\"agent.watch\", { name: watchedAgentName })","602:baseName(c.path)","602:c.kind === \"removed\" ? \"−\" : c.kind === \"created\" ? \"+\" : \"~\"","602:c.path","605:$t(\"agent.watching\")","607:$t(\"agent.showLog\")","608:$agentTimeline.length ? `(${$agentTimeline.length})` : \"\"","608:$t(\"agent.log\")","615:selectedTag","616:visible.length"],
  ...
  "StatusBar.svelte": ["93:itemCount","93:totalCount","95:itemCount","95:itemCount === 1 ? \"\" : \"s\"","101:selectedCount","101:selectedSize > 0 ? ` — ${formatSize(selectedSize)}` : \"\"","114:filteredHiddenTitle","115:filteredHiddenText","123:unreadableTitle","124:unreadableText","133:git.upstream ? `Tracking ${git.upstream}` : \"No upstream branch\"","134:git.branch || \"detached\"","135:git.behind","136:git.ahead","150:diskLabel"],
...
const APP_MARKUP_OFFENDERS = ["6426:$t(\"palette.openAgentBoardWindow\")","6438:$t(\"sidebar.repositories\")","6441:$t(\"sidebar.repositories\")","6447:$agentSessions.length === 0 ? $t(\"tb.openConsole\") : $agentSessions.length === 1 ? $t(\"tb.openConsoleOne\") : $t(\"tb.openConsoleMany\", { count: $agentSessions.length })","6455:$t(\"tb.aiConsole\")","6457:$agentSessions.length","6457:$t(\"tb.agentsRunning\", { count: $agentSessions.length })","6464:$t(\"tb.showDetailsPane\")","6469:$t(\"cmd.showHidden\")","6474:$t(\"cmd.folderSizes\")","6479:$t(\"tb.resetSettings\")","6566:$t(\"tb.paneWidth\")","6645:$t(\"tb.resizeNav\")","6646:$t(\"tb.resizeTip\")","6809:$t(\"tb.resizeDetails\")","6810:$t(\"tb.resizeTip\")","6819:$t(\"tb.popoutTip\")","6820:$t(\"tb.popoutAria\")","6825:$t(\"tb.defaultTab\")","6833:$t(\"tb.preview\")","6834:$t(\"view.details\")","6838:$t(\"tb.paneWidth\")","6854:$t(\"tb.previewOrDetails\")","6855:$t(\"tb.dragPopoutTip\")","6866:$t(\"tb.preview\")","6872:$t(\"view.details\")","7108:confirm.title","7123:passwordPrompt.title","7461:runConfirm.title","7479:macroParamPromptFor.macro.name","7745:$t(\"dnd.dropToImport\")"];
...
const APP_SCRIPT_BASENAME_ALLOWLIST = [2774, 2789];
