...
const REGISTRY: Record<string, string[]> = {
  ...
  "TrashView.svelte": ["204:$t(\"trash.title\")","217:itemCountLabel","217:selectedCountLabel","222:allSelected ? $t(\"trash.deselectAll\") : $t(\"trash.selectAll\")","225:$t(\"trash.restoreSelected\")","228:$t(\"trash.emptySelected\")","231:$t(\"trash.emptyAll\")","234:$t(\"trash.refresh\")","245:$t(\"trash.restoreFailed\", { name: displaySafeName(f.name), error: f.error })","253:$t(\"trash.loading\")","255:$t(\"trash.error\", { error })","263:degradedMessage","266:$t(\"trash.empty\")","286:rowsNoteMessage","291:$t(\"trash.selectAll\")","293:$t(\"trash.columnsName\")","294:$t(\"trash.columnsOriginalPath\")","295:$t(\"trash.columnsDeleted\")","312:formatSize(e.size)","315:formatDate(e.time_deleted * 1000)","325:$t(\"trash.emptyConfirmTitle\")"],
