...
const REGISTRY: Record<string, string[]> = {
  ...
  "TrashView.svelte": ["301:$t(\"trash.title\")","337:itemCountLabel","337:selectedCountLabel","339:$t(\"trash.stillLoading\")","339:selectedCountLabel","341:selectedCountLabel","355:$t(\"trash.moreActions\")","356:$t(\"trash.moreActions\")","375:allSelected ? $t(\"trash.deselectAll\") : $t(\"trash.selectAll\")","383:$t(\"trash.restoreSelected\")","391:$t(\"trash.emptySelected\")","398:$t(\"trash.emptyAll\")","404:$t(\"trash.refresh\")","408:$t(\"trash.docs\")","419:$t(\"trash.restoreFailed\", { name: displaySafeName(f.name), error: f.error })","427:$t(\"trash.loading\")","429:$t(\"trash.error\", { error })","465:noticeMessage","468:$t(\"trash.empty\")","514:degradedMessage","519:$t(\"trash.selectAll\")","521:$t(\"trash.columnsName\")","522:$t(\"trash.columnsOriginalPath\")","523:$t(\"trash.columnsDeleted\")","541:formatSize(e.size)","544:formatDate(e.time_deleted * 1000)","554:$t(\"trash.emptyConfirmTitle\")"],
