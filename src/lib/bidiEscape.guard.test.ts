...
const REGISTRY: Record<string, string[]> = {
  ...
  "TrashView.svelte": ["229:$t(\"trash.title\")","259:itemCountLabel","259:selectedCountLabel","261:$t(\"trash.stillLoading\")","261:selectedCountLabel","263:selectedCountLabel","271:allSelected ? $t(\"trash.deselectAll\") : $t(\"trash.selectAll\")","274:$t(\"trash.restoreSelected\")","277:$t(\"trash.emptySelected\")","280:$t(\"trash.emptyAll\")","283:$t(\"trash.refresh\")","294:$t(\"trash.restoreFailed\", { name: displaySafeName(f.name), error: f.error })","302:$t(\"trash.loading\")","304:$t(\"trash.error\", { error })","320:noticeMessage","323:$t(\"trash.empty\")","358:degradedMessage","363:$t(\"trash.selectAll\")","365:$t(\"trash.columnsName\")","366:$t(\"trash.columnsOriginalPath\")","367:$t(\"trash.columnsDeleted\")","385:formatSize(e.size)","388:formatDate(e.time_deleted * 1000)","398:$t(\"trash.emptyConfirmTitle\")"],
