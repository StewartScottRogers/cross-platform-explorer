...
const REGISTRY: Record<string, string[]> = {
  ...
  "TrashView.svelte": ["229:$t(\"trash.title\")","265:itemCountLabel","265:selectedCountLabel","267:$t(\"trash.stillLoading\")","267:selectedCountLabel","269:selectedCountLabel","277:allSelected ? $t(\"trash.deselectAll\") : $t(\"trash.selectAll\")","280:$t(\"trash.restoreSelected\")","283:$t(\"trash.emptySelected\")","286:$t(\"trash.emptyAll\")","289:$t(\"trash.refresh\")","300:$t(\"trash.restoreFailed\", { name: displaySafeName(f.name), error: f.error })","308:$t(\"trash.loading\")","310:$t(\"trash.error\", { error })","346:noticeMessage","349:$t(\"trash.empty\")","395:degradedMessage","400:$t(\"trash.selectAll\")","402:$t(\"trash.columnsName\")","403:$t(\"trash.columnsOriginalPath\")","404:$t(\"trash.columnsDeleted\")","422:formatSize(e.size)","425:formatDate(e.time_deleted * 1000)","435:$t(\"trash.emptyConfirmTitle\")"],
