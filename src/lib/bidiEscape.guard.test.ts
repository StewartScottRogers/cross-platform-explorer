...
const REGISTRY: Record<string, string[]> = {
  ...
  "ExplorerPane.svelte": ["481:$t(\"menu.view\")","483:$t(\"view.details\")","484:$t(\"view.list\")","485:$t(\"tb.icons\")","486:$t(\"view.gallery\")","490:$t(\"tb.sortBy\")","492:$t(\"sort.name\")","493:$t(\"tb.modified\")","494:$t(\"sort.type\")","495:$t(\"sort.size\")","499:$t(\"tb.direction\")","501:$t(\"cmd.ascending\")","502:$t(\"cmd.descending\")","506:$t(\"cmd.showHidden\")","513:$t(\"tb.fileList\")","549:$t(\"agent.watch\", { name: watchedAgentName })","551:baseName(c.path)","551:c.kind === \"removed\" ? \"−\" : c.kind === \"created\" ? \"+\" : \"~\"","551:c.path","554:$t(\"agent.watching\")","556:$t(\"agent.showLog\")","557:$agentTimeline.length ? `(${$agentTimeline.length})` : \"\"","557:$t(\"agent.log\")","564:selectedTag","565:visible.length"],
...
const APP_MARKUP_OFFENDERS = ["6386:$t(\"palette.openAgentBoardWindow\")","6398:$t(\"sidebar.repositories\")","6401:$t(\"sidebar.repositories\")","6407:$agentSessions.length === 0 ? $t(\"tb.openConsole\") : $agentSessions.length === 1 ? $t(\"tb.openConsoleOne\") : $t(\"tb.openConsoleMany\", { count: $agentSessions.length })","6415:$t(\"tb.aiConsole\")","6417:$agentSessions.length","6417:$t(\"tb.agentsRunning\", { count: $agentSessions.length })","6424:$t(\"tb.showDetailsPane\")","6429:$t(\"cmd.showHidden\")","6434:$t(\"cmd.folderSizes\")","6439:$t(\"tb.resetSettings\")","6526:$t(\"tb.paneWidth\")","6605:$t(\"tb.resizeNav\")","6606:$t(\"tb.resizeTip\")","6767:$t(\"tb.resizeDetails\")","6768:$t(\"tb.resizeTip\")","6777:$t(\"tb.popoutTip\")","6778:$t(\"tb.popoutAria\")","6783:$t(\"tb.defaultTab\")","6791:$t(\"tb.preview\")","6792:$t(\"view.details\")","6796:$t(\"tb.paneWidth\")","6812:$t(\"tb.previewOrDetails\")","6813:$t(\"tb.dragPopoutTip\")","6824:$t(\"tb.preview\")","6830:$t(\"view.details\")","7045:confirm.title","7060:passwordPrompt.title","7398:runConfirm.title","7416:macroParamPromptFor.macro.name","7682:$t(\"dnd.dropToImport\")"];
