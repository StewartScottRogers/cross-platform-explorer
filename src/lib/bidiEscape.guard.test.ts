...
const REGISTRY: Record<string, string[]> = {
  ...
  "TrashView.svelte": ["186:$t(\"trash.title\")","194:itemCountLabel","194:selectedCountLabel","199:allSelected ? $t(\"trash.deselectAll\") : $t(\"trash.selectAll\")","202:$t(\"trash.restoreSelected\")","205:$t(\"trash.emptySelected\")","208:$t(\"trash.emptyAll\")","211:$t(\"trash.refresh\")","222:$t(\"trash.restoreFailed\", { name: displaySafeName(f.name), error: f.error })","230:$t(\"trash.loading\")","232:$t(\"trash.error\", { error })","240:degradedMessage","243:$t(\"trash.empty\")","255:degradedMessage","260:$t(\"trash.selectAll\")","262:$t(\"trash.columnsName\")","263:$t(\"trash.columnsOriginalPath\")","264:$t(\"trash.columnsDeleted\")","281:formatSize(e.size)","284:formatDate(e.time_deleted * 1000)","294:$t(\"trash.emptyConfirmTitle\")"],
