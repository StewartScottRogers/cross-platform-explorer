...
const APP_MARKUP_OFFENDERS = ["6534:$t(\"palette.openAgentBoardWindow\")","6546:$t(\"sidebar.repositories\")","6549:$t(\"sidebar.repositories\")","6555:$agentSessions.length === 0 ? $t(\"tb.openConsole\") : $agentSessions.length === 1 ? $t(\"tb.openConsoleOne\") : $t(\"tb.openConsoleMany\", { count: $agentSessions.length })","6563:$t(\"tb.aiConsole\")","6565:$agentSessions.length","6565:$t(\"tb.agentsRunning\", { count: $agentSessions.length })","6572:$t(\"tb.showDetailsPane\")","6577:$t(\"cmd.showHidden\")","6582:$t(\"cmd.folderSizes\")","6587:$t(\"tb.resetSettings\")","6674:$t(\"tb.paneWidth\")","6753:$t(\"tb.resizeNav\")","6754:$t(\"tb.resizeTip\")","6917:$t(\"tb.resizeDetails\")","6918:$t(\"tb.resizeTip\")","6927:$t(\"tb.popoutTip\")","6928:$t(\"tb.popoutAria\")","6933:$t(\"tb.defaultTab\")","6941:$t(\"tb.preview\")","6942:$t(\"view.details\")","6946:$t(\"tb.paneWidth\")","6962:$t(\"tb.previewOrDetails\")","6963:$t(\"tb.dragPopoutTip\")","6974:$t(\"tb.preview\")","6980:$t(\"view.details\")","7216:confirm.title","7231:passwordPrompt.title","7569:runConfirm.title","7587:macroParamPromptFor.macro.name","7853:$t(\"dnd.dropToImport\")"];
