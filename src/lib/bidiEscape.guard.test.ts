...
const REGISTRY: Record<string, string[]> = {
  ...
  "TrashView.svelte": ["160:$t(\"trash.title\")","161:itemCountLabel","161:selectedCountLabel","166:allSelected ? $t(\"trash.deselectAll\") : $t(\"trash.selectAll\")","169:$t(\"trash.restoreSelected\")","172:$t(\"trash.emptySelected\")","175:$t(\"trash.emptyAll\")","178:$t(\"trash.refresh\")","189:$t(\"trash.restoreFailed\", { name: displaySafeName(f.name), error: f.error })","197:$t(\"trash.loading\")","199:$t(\"trash.error\", { error })","204:$t(\"trash.degraded\")","206:$t(\"trash.empty\")","210:$t(\"trash.selectAll\")","212:$t(\"trash.columnsName\")","213:$t(\"trash.columnsOriginalPath\")","214:$t(\"trash.columnsDeleted\")","231:formatSize(e.size)","234:formatDate(e.time_deleted * 1000)","244:$t(\"trash.emptyConfirmTitle\")"],
