...
const REGISTRY: Record<string, string[]> = {
  ...
  "TrashView.svelte": ["160:$t(\"trash.title\")","164:itemCountLabel","164:selectedCountLabel","169:allSelected ? $t(\"trash.deselectAll\") : $t(\"trash.selectAll\")","172:$t(\"trash.restoreSelected\")","175:$t(\"trash.emptySelected\")","178:$t(\"trash.emptyAll\")","181:$t(\"trash.refresh\")","192:$t(\"trash.restoreFailed\", { name: displaySafeName(f.name), error: f.error })","200:$t(\"trash.loading\")","202:$t(\"trash.error\", { error })","210:$t(\"trash.degraded\")","213:$t(\"trash.empty\")","217:$t(\"trash.selectAll\")","219:$t(\"trash.columnsName\")","220:$t(\"trash.columnsOriginalPath\")","221:$t(\"trash.columnsDeleted\")","238:formatSize(e.size)","241:formatDate(e.time_deleted * 1000)","251:$t(\"trash.emptyConfirmTitle\")"],
