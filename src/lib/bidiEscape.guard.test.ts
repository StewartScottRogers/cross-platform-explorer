...
const APP_MARKUP_OFFENDERS = ["6526:$t(\"palette.openAgentBoardWindow\")","6538:$t(\"sidebar.repositories\")","6541:$t(\"sidebar.repositories\")","6547:$agentSessions.length === 0 ? $t(\"tb.openConsole\") : $agentSessions.length === 1 ? $t(\"tb.openConsoleOne\") : $t(\"tb.openConsoleMany\", { count: $agentSessions.length })","6555:$t(\"tb.aiConsole\")","6557:$agentSessions.length","6557:$t(\"tb.agentsRunning\", { count: $agentSessions.length })","6564:$t(\"tb.showDetailsPane\")","6569:$t(\"cmd.showHidden\")","6574:$t(\"cmd.folderSizes\")","6579:$t(\"tb.resetSettings\")","6666:$t(\"tb.paneWidth\")","6745:$t(\"tb.resizeNav\")","6746:$t(\"tb.resizeTip\")","6909:$t(\"tb.resizeDetails\")","6910:$t(\"tb.resizeTip\")","6919:$t(\"tb.popoutTip\")","6920:$t(\"tb.popoutAria\")","6925:$t(\"tb.defaultTab\")","6933:$t(\"tb.preview\")","6934:$t(\"view.details\")","6938:$t(\"tb.paneWidth\")","6954:$t(\"tb.previewOrDetails\")","6955:$t(\"tb.dragPopoutTip\")","6966:$t(\"tb.preview\")","6972:$t(\"view.details\")","7208:confirm.title","7223:passwordPrompt.title","7561:runConfirm.title","7579:macroParamPromptFor.macro.name","7845:$t(\"dnd.dropToImport\")"];
