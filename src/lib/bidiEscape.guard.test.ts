...
const APP_MARKUP_OFFENDERS = ["6401:$t(\"palette.openAgentBoardWindow\")","6413:$t(\"sidebar.repositories\")","6416:$t(\"sidebar.repositories\")","6422:$agentSessions.length === 0 ? $t(\"tb.openConsole\") : $agentSessions.length === 1 ? $t(\"tb.openConsoleOne\") : $t(\"tb.openConsoleMany\", { count: $agentSessions.length })","6430:$t(\"tb.aiConsole\")","6432:$agentSessions.length","6432:$t(\"tb.agentsRunning\", { count: $agentSessions.length })","6439:$t(\"tb.showDetailsPane\")","6444:$t(\"cmd.showHidden\")","6449:$t(\"cmd.folderSizes\")","6454:$t(\"tb.resetSettings\")","6541:$t(\"tb.paneWidth\")","6620:$t(\"tb.resizeNav\")","6621:$t(\"tb.resizeTip\")","6783:$t(\"tb.resizeDetails\")","6784:$t(\"tb.resizeTip\")","6793:$t(\"tb.popoutTip\")","6794:$t(\"tb.popoutAria\")","6799:$t(\"tb.defaultTab\")","6807:$t(\"tb.preview\")","6808:$t(\"view.details\")","6812:$t(\"tb.paneWidth\")","6828:$t(\"tb.previewOrDetails\")","6829:$t(\"tb.dragPopoutTip\")","6840:$t(\"tb.preview\")","6846:$t(\"view.details\")","7069:confirm.title","7084:passwordPrompt.title","7422:runConfirm.title","7440:macroParamPromptFor.macro.name","7706:$t(\"dnd.dropToImport\")"];
