...
//! as a **sidecar tenant** of the platform (ADR 0001 / CPE-259/260), peer to the Agent Deck
...
//! is a manifest, not host code — mirroring the Agent Deck's agent registry (CPE-278).
